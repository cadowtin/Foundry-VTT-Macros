...
Has a popup to pick between which cunning action to use. Writes a message out to chat for which one picked.

For Dash applies an effect to the character that doubles *walking* speed.

For Hide, has the character roll stealth (works well with conditional visibility).
